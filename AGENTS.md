...
- CI tests the supported minimum Node.js 22.12.0 and the release runtime Node.js 24.19.0. Release reproduction uses the exact Node/npm versions documented in `docs/releasing.md`.
